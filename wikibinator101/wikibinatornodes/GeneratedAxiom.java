...
public class GeneratedAxiom extends AbstractNode{
	...
	/** The HaltedLambda of course cant create just any Λ (axiomnode) it wants,
	but it returns (todo choose a datastruct) a linkedlist of the childs [v l r bitOrIsItATruthValue]
	to create a Λ of those, and since its in a GeneratedAxiom its formal-verified to (converge toward) only create
	Λ's which dont create TruthValue.bull IF the set of statements which derived it dont create TruthValue.bull.
	*/
	public GeneratedAxiom(boolean tv, HaltedLambda callThisOnA_ViewNodeAsHaltedLambda_returnsLinkedlistEtcLikeReflectedViewOfNodeToCreate){
		super(tv, callThisOnA_ViewNodeAsHaltedLambda_returnsLinkedlistEtcLikeReflectedViewOfNodeToCreate);
	}
	
	public HaltedLambda callThisOnA_ViewNodeAsHaltedLambda_returnsLinkedlistEtcLikeReflectedViewOfNodeToCreate(){
