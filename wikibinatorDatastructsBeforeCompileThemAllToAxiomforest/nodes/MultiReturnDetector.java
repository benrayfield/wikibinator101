...
public class MultiReturnDetector extends AbstractNode{
	...
	public MultiReturnDetector(Rfpd cacheKeyA, Rfpd cacheKeyB, No mutuallyAssuredDestructionTrigger){
		super(cacheKeyA, cacheKeyB, mutuallyAssuredDestructionTrigger);
	}
